...
void forward_batchnorm_layer_infer_gpu(layer l, network net)
{
    if(l.type == BATCHNORM) copy_gpu(l.outputs*l.batch, net.input_gpu, 1, l.output_gpu, 1);
    copy_gpu(l.outputs*l.batch, l.output_gpu, 1, l.x_gpu, 1);
    normalize_gpu(l.output_gpu, l.rolling_mean_gpu, l.rolling_variance_gpu, l.batch, l.out_c, l.out_h*l.out_w);
...
void forward_batchnorm_layer_quant_gpu(layer l, network net)
{
    if(net.train){
        ...
        // copy_gpu(l.out_c*l.batch, l.biases_bn_backup_gpu, 1, l.biases_gpu, 1);   
...
void backward_batchnorm_layer_infer_gpu(layer l, network net)
{
    // l.mean_gpu = l.rolling_mean_gpu;
    // l.variance_gpu = l.rolling_variance_gpu;
...
{
    // backward_batch_normalize_bias_gpu(l.bias_updates_gpu, l.rolling_variance_gpu, l.scales_gpu, l.out_c);
    ...
    //scale_bias_gpu(l.delta_gpu, l.scales_gpu, l.batch, l.out_c, 1*1);

    //fast_mean_delta_gpu(l.delta_gpu, l.variance_gpu, l.batch, l.out_c, l.out_w*l.out_h, l.mean_delta_gpu);
    //fast_variance_delta_gpu(l.x_gpu, l.delta_gpu, l.mean_gpu, l.variance_gpu, l.batch, l.out_c, 1*1, l.variance_delta_gpu);
    //normalize_delta_gpu(l.x_gpu, l.mean_gpu, l.variance_gpu, l.mean_delta_gpu, l.variance_delta_gpu, l.batch, l.out_c, l.out_w*l.out_h, l.delta_gpu);
}
#endif
